...
<title>付款成功页面</title>
<link rel="stylesheet"  type="text/css" href="${pageContext.request.contextPath}/introduction/AmazeUI-2.4.2/assets/css/amazeui.css"/>
...
<link href="${pageContext.request.contextPath}/introduction/css/sustyle.css" rel="stylesheet" type="text/css" />
...
<div class="nav white">
	<div class="logo"><img src="${pageContext.request.contextPath}/introduction/images/logo.png" /></div>
    <div class="logoBig">
      <li><img src="${pageContext.request.contextPath}/introduction/images/logobig.png" /></li>
    </div>
   ...
   <div class="successInfo">
     ...
     <div class="option">
       <span class="info">您可以</span>
        <a href="${pageContext.request.contextPath}/introduction/person/order.html" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
        <a href="${pageContext.request.contextPath}/introduction/person/orderinfo.html" class="J_MakePoint">查看<span>交易详情</span></a>
     </div>
    </div>
  </div>
</div>
